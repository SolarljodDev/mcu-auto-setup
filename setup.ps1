...
[System.IO.File]::WriteAllText("$Root\mcu.ld", $ldContent, (New-Object System.Text.UTF8Encoding $false))
Write-Host ""
Write-Host ("[mcu.ld] Generated  ({0} KB Flash @ {1},  {2} KB RAM @ {3})" -f $flashKB, $flashBase, $ramKB, $ramBase) -ForegroundColor Green
